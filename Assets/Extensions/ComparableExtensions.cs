...
public static class ComparableExtensions {
	...
	/// <summary>
	/// Checks whether a given item is strictly between the range (<see cref="lower"/>, <see cref="upper"/>)
	...
	/// <summary>
	/// Checks whether a given item is strictly within the range [<see cref="lower"/>, <see cref="upper"/>]
